		...
		<div class="icon-nutrition-top clearfix">
			<?php if( get_field('nutrition_qualifications') ) { ?>
				...
				<?php if( in_array( 'gmo', get_field('nutrition_qualifications') ) ) { ?>
					<div class="one-sixth">
						<img src="<?php bloginfo('template_directory'); ?>/img/icon-gmo.svg" alt="gmo" class="" >
					</div>
				<?php } ?>
				...
				<?php } ?>
				<?php if( in_array( 'gluten-free', get_field('nutrition_qualifications') ) ) { ?>
					<div class="one-sixth">
						<img src="<?php bloginfo('template_directory'); ?>/img/icon-gluten-free.svg" alt="gluten free" class="" >
					</div>
				<?php } ?>
			<?php } ?>	
		</div>
